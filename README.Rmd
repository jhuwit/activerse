...
`activerse` is a lightweight helper package that attaches [`actibase`](https://github.com/jhuwit/actibase), [`actiread`](https://github.com/jhuwit/actiread), [`actimetrics`](https://github.com/jhuwit/actimetrics), [`actisensorlog`](https://github.com/jhuwit/actisensorlog), and [`actiwalkability`](https://github.com/jhuwit/actiwalkability) together.
<!-- activerse-intro:end -->
